...
changed_files {
  ...
  // The "fips_path" group tracks all FIPS-path artifact classifier inputs:
  // HCL config examples, Helm values, Markdown posture documents,
  // COMPLIANCE-EVIDENCE.md, and wording-guardrail scripts.
  group "fips_path" {
    match {
      base_dir = [
        "fips-path",
